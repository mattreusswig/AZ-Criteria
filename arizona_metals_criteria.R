...
# Function to compute the metal's total recoverable criterion in ug/L. This function
# assumes the permittee's metal translator is equal to the conversion factor (CF)
